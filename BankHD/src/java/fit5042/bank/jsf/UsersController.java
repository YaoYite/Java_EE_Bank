...
import fit5042.bank.jsf.util.JsfUtil;
import fit5042.bank.jsf.util.PaginationHelper;
import fit5042.bank.sessionbean.UsersFacade;
...
public class UsersController implements Serializable {
    ...
    @EJB
    private fit5042.bank.sessionbean.UsersFacade ejbFacade;
    ...
    public String create() {
        try {
            current.setPassword(sha256(current.getPassword()));
